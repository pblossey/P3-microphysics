...
!bloss          Q_nuc = cons6*cdist1(i,k)*gamma(7.+mu_c(i,k))*exp(aimm*(273.15-t(i,k)))*dum**2
          Q_nuc = cons6*cdist1(i,k)*gamma(7.+mu_c(i,k))*exp( aimm*(273.15-t(i,k))+ 2.*log(dum) )
